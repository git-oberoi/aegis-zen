...
export const buildBriefingPrompt = (tasks, habits, history) => `
${AEGIS_SYSTEM_PROMPT}
Generate a personalized morning briefing for the user named Shivam.
...
Instructions:
1. Greet them warmly as Shivam (e.g. "Good Morning Shivam.").
